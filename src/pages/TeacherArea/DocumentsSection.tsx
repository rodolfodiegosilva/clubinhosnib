...
import {  DocumentData,  setDocumentData, clearDocumentData } from 'store/slices/documents/documentSlice';
      ...
      >
        ...
        <DialogContent dividers>
          {documentData?.media?.url ? (
            <iframe
              src={
                documentData.media.platform === 'googledrive'
                  ? documentData.media.url.replace('/view?usp=', '/preview?usp=')
                  : documentData.media.platform === 'youtube'
                  ? documentData.media.url.replace('watch?v=', 'embed/')
                  : documentData.media.url
              }
